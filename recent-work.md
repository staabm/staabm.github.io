...
- [PhpFileCleaner: Use strcspn instead of regex for fast-skip in clean()](https://github.com/phpstan/phpstan-src/pull/5600) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Remove dead code from FileExcluder](https://github.com/phpstan/phpstan-src/pull/5598) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Partly revert wrong expectations](https://github.com/phpstan/phpstan-src/pull/5589) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (6 days ago)
- [Narrow `DateInterval-&gt;days` after `DateTimeInterface-&gt;diff()`](https://github.com/phpstan/phpstan-src/pull/5588) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (6 days ago)
