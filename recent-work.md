...
- [Be more forgiving with error-handlers not respecting the `@` operator](https://github.com/sebastianbergmann/phpunit/pull/5765) on [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) (today)
