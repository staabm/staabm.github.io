...
- [`ApiPhpDocUsageProvider-&gt;shouldMarkMemberAsUsed()` is private](https://github.com/shipmonk-rnd/dead-code-detector/pull/430) on [shipmonk-rnd/dead-code-detector](https://github.com/shipmonk-rnd/dead-code-detector) (1 day ago)
- [`pcntl_exec()` is not supported by blackfire](https://github.com/phpstan/phpstan-src/pull/6409) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (1 day ago)
- [`LanguageLevelTypeAware` pseudo-types should be turned into phpdoc-type](https://github.com/ondrejmirtes/BetterReflection/pull/46) on [ondrejmirtes/BetterReflection](https://github.com/ondrejmirtes/BetterReflection) (1 day ago)
- [`LanguageLevelTypeAware` pseudo-types should be turned into phpdoc-type](https://github.com/Roave/BetterReflection/pull/1579) on [Roave/BetterReflection](https://github.com/Roave/BetterReflection) (2 days ago)
- [Bump expected turbo version](https://github.com/phpstan/phpstan-src/pull/6394) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (3 days ago)
- [fix `pg_loopen` phpdoc return type](https://github.com/JetBrains/phpstorm-stubs/pull/1940) on [JetBrains/phpstorm-stubs](https://github.com/JetBrains/phpstorm-stubs) (5 days ago)
- [Handle `resource` types in builder APIs](https://github.com/nikic/PHP-Parser/pull/1166) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (5 days ago)
- [verify tests](https://github.com/phpstan/phpstan-src/pull/6387) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (5 days ago)
...
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) - [6.73.0](https://github.com/Roave/BetterReflection/releases/tag/6.73.0) (2 days ago)
- [zizmorcore/zizmor-action](https://github.com/zizmorcore/zizmor-action) - [v0.6.4](https://github.com/zizmorcore/zizmor-action/releases/tag/v0.6.4) (2 days ago)
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) - [13.3.3](https://github.com/sebastianbergmann/phpunit/releases/tag/13.3.3) (2 days ago)
