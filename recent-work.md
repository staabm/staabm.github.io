...
- [pavel-rossinsky](https://github.com/pavel-rossinsky) (3 days ago)
...
- [Simplify `AccessoryArrayListType`](https://github.com/phpstan/phpstan-src/pull/6107) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Remove unnecessary work in `BooleanOrHandler`](https://github.com/phpstan/phpstan-src/pull/6106) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Iterative NullsafeOperatorHelper](https://github.com/phpstan/phpstan-src/pull/6105) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Skip scope type lookup for expressions without nullsafe operators](https://github.com/phpstan/phpstan-src/pull/6104) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Prevent duplicate `filterByTruthyValue()` work in `NodeScopeResolver`](https://github.com/phpstan/phpstan-src/pull/6103) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (4 days ago)
- [Disable runtime assertions](https://github.com/TomasVotruba/php-parser-speed-comparison-2026/pull/12) on [TomasVotruba/php-parser-speed-comparison-2026](https://github.com/TomasVotruba/php-parser-speed-comparison-2026) (5 days ago)
- [Fix &#34;ob_get_*() === false will always evaluate to false&#34; false positive](https://github.com/phpstan/phpstan-src/pull/6097) on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (6 days ago)
- [Refactor getOffsetValueType to remove exception throw](https://github.com/erickskrauch/phpstan-yii2/pull/19) on [erickskrauch/phpstan-yii2](https://github.com/erickskrauch/phpstan-yii2) (6 days ago)
