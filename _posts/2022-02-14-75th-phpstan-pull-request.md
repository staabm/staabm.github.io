...
## today my 75th pull request to PHPStan was merged.
...
If you are curious, [I did this thing for a lot of functions](https://github.com/phpstan/phpstan-src/pulls?q=is%3Apr+sort%3Aupdated-desc+author%3Astaabm+is%3Amerged++non-empty-string).
