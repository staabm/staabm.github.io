...
- [database schema changes which are not compatible](https://staabm.github.io/2022/08/05/phpstan-dba-syntax-error-detection.html) with the types defined in the source
